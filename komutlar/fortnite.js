...
if (!['pc','xbl','psn'].includes(args[0])) message.channel.send('**Lütfen Platform Seçin**: `spfortniter pc | xbl | psn kullanıcıadı` **Örnek**: `spfortniter pc Dark` ');

if (!args[1]) return message.channel.send('**Lütfen Kullanıcı İsmi Girin**: `spfortniter pc | xbl | psn kullanıcıadı` **Örnek**: spfortniter pc Dark` ');
